...
// Section: 2
// Assignment: 1 Part_2
// Precondition: Needs input.txt to run. Because it gets all the input data from it.
// Description: This class is the tester for Calc.
//-------------------------------------------------
...
public class CalcTester extends Stack<Integer> {
